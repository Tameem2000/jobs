                ...
                <div class="mb-4 p-6 bg-gray-50 border border-gray-50 rounded-lg shadow-sm">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <select name="industry" id="industry" class="{{ $errors->has('industry') ? 'outline-red-500' : 'outline-grey-300' }} outline outline-1 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="mb-4 p-6 bg-gray-50 border border-gray-50 rounded-lg shadow-sm">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="email" name="owner_email" id="owner_email" value="{{ old('owner_email') }}"
                            class="{{ $errors->has('owner_email') ? 'outline-red-500' : 'outline-grey-300' }} outline outline-1 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        @error('owner_email')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
